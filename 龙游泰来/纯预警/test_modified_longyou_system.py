...
# -*- coding: utf-8 -*-
"""
测试修改后的垃圾焚烧预警系统 - 龙游泰来 (三炉配置)
基于shishi_data_yujing_gz.py的修改版本
"""
...
def test_longyou_modified_system():
    """使用龙游泰来数据测试修改后的预警系统"""
    
    # 数据文件路径 (根据用户修改，使用6.3.xlsx)
    data_file = "衢州/数据上/数据上/龙游泰来/5.23.xlsx"
    output_dir = "预警输出"
    ...
    if not os.path.exists(data_file):
        ...
        # 尝试使用5.23.csv作为备选
        data_file_backup = "数据上/数据上/龙游泰来/5.23.csv"
    ...
    print("=" * 70)
    print("垃圾焚烧预警系统测试 - 龙游泰来 (三炉配置) - 修改版")
    print("=" * 70)
